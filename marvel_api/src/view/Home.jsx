...
const Home = () => {
    ...
    useEffect(() => {
        ...
        setAutenticado(!!usuarioAutenticado); // Convertir a booleano
    }, []);

    const styles = {
        main1: "relative h-[calc(100vh-100px)] font-bebas",
        img: "w-full h-full",
        ...
        h1: "text-2xl mb-2 text-center text-blue-500 font-bebas", 
        p: "text-xs md:text-sm text-center mt-4 px-4 font-montserrat",
        ...
        contenedor3: "absolute opacity-70 w-full h-full inset-0 0 lg:opacity-95 lg:ml-auto lg:top-1/2 lg:transform lg:-translate-y-1/2 lg:w-1/3  flex flex-col justify-center items-center bg-gray-800 lg:h-[110%] mr-4   text-white p-2 overflow-auto",
        ...
        <main>
            <div className={styles.main1}>
                ...
                <div className={styles.contenedor}>
                    ...
                    {autenticado ? (
                        <div>
                            <Boton  estilo="BotonRojo1" texto="Personajes" onClick={() => navigate('/personajes')} />
                        </div>
                    ) : (
                        <NavLink to="/login" className={styles.boton}>Inicia ahora</NavLink>
                    )}
                </div>
            </div>
            ...
            <section className={styles.main2}>
                <article className={styles.picture}>
                    <img className={styles.img2} src="https://th.bing.com/th/id/OIP.beCLCfEVOldmQGh0k0MWggHaEK?w=283&h=180&c=7&r=0&o=5&pid=1.7" alt="Iron Man" />
                    <p className={styles.parrafo}>Iron Man</p>
                </article>
                <article className={styles.picture}>
                    <img className={styles.img2} src="https://th.bing.com/th/id/OIP.ZdnVCbgivDbB8L7ORzn08wHaE_?rs=1&pid=ImgDetMain" alt="Wonder Woman" />
                    <p className={styles.parrafo}>Wonder Woman</p>
                </article>
                <article className={styles.picture}>
                    <img className={styles.img2} src="https://th.bing.com/th/id/OIP.JXANIrUffFkmk-5GIWQ6jwHaEK?w=291&h=180&c=7&r=0&o=5&pid=1.7" alt="Hulk" />
                    <p className={styles.parrafo}>Hulk</p>
                </article>
                <article className={styles.picture}>
                    <img className={styles.img2} src="https://th.bing.com/th/id/OIP.WGiVk-EIVJxonWc6KpLfsQHaEK?w=334&h=187&c=7&r=0&o=5&pid=1.7" alt="Captain America" />
                    <p className={styles.parrafo}>Captain America</p>
                </article>
            </section>

            <div className={styles.main3}>
                <img className={styles.img3} src="https://wallpapercave.com/wp/wp3533805.jpg" alt="Marvel Background" />
                <div className={styles.contenedor3}>
                    ...
                    {autenticado ? (
                        ...
                        <Boton estilo="BotonRojo1" texto="Inicia ahora" onClick={() => navigate('/login')} />
                    )}
                </div>
            </div>
        </main>
